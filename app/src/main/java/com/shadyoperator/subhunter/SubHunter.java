package com.shadyoperator.subhunter;
...
public class SubHunter extends Activity {
    ...
    of classes that are needed to do some drawing */
    ImageView gameView;
    Bitmap blankBitmap;
    Canvas canvas;
    Paint paint;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Initialize the size based variables based on the screen resolution
        ...
        //Tells Adroid to set drawing as the view for this app
    ...
    void draw() {
        ...
        //Wipes the screen with a white color
